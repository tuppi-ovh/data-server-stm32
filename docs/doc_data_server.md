...
rectangle "BOX" as M_BOX {
    ...
    note right
    <img:http://tuppi.ovh/images/img_doc_data_server_raspberry.png{scale=0.5}>
    end note

    rectangle "433 MHz Receiver" as M_433MHz
    note right
    <img:http://tuppi.ovh/images/img_doc_data_server_rxb6.png{scale=0.5}>
    end note
    ...
    note right
    <img:http://tuppi.ovh/images/img_doc_data_server_stm32.png{scale=0.5}>
    end note 
...
note right
<img:http://tuppi.ovh/images/img_doc_data_server_dht22.png{scale=0.5}>
end note
